 ...
 * @date 12.2.2011
 * @version 移植于客户端4.5   未做修改
 * fuction:This class does most of the work of wrapping the {@link PopupWindow} so it's simpler to use. 
 * 
 */
public class CustomPopupWindow {
	...
	public void showDropDown(int xOffset, int yOffset) {
		...
		window.setAnimationStyle(R.style.Animations_PopDownMenu_Left);   //移植需要的样式

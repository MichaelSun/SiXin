 ...
 *
 */
public class AttentionSettingModel extends ContactBaseModel {
	private long mCount;
	...
	public AttentionSettingModel(ThirdContactModel thirdContactModel){
		...
		this.mSmallHeadUrl = thirdContactModel.getmHeadUrl();
...
//		contactDao.update_Contact_Attention(userId, isAttention);
	...
	public String toString() {
		return "AttentionSettingModel [mCount="
				...
				+ mContactName + ", mHeadUrl=" + mSmallHeadUrl + "]"+"\n";
	}

...
public abstract class ChatBaseItem {
	...
	@ORM(mappingColumn=ChatHistory_Column.IS_GROUP_MESSAGE)
	public int mIsGroupMessage = MESSAGE_ISGROUP.IS_SINGLE;//默认为单人聊天消息
	
	@ORM(mappingColumn=ChatHistory_Column.GROUP_ID)
	public long mGroupId = -1;//默认为单人聊天消息
	...
	@ORM(mappingColumn=ChatHistory_Column.FEED_ID)
	public long mFeedId = -1;//消息发送者头像链接
	
	@ORM(mappingColumn=ChatHistory_Column.DOMAIN)
	public String mDomain = "";//用户所在域

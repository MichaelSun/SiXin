...
//
	...
	public String getmHeadUrl() {
		return getmSmallHeadUrl();
	}
	
	public String getmSmallHeadUrl() {
//		if(SystemUtil.mDebug){
//			SystemUtil.logd("获取小图="+mSmallHeadUrl);
//		}
		return mSmallHeadUrl;
	}


	public void setmSmallHeadUrl(String mHeadUrl) {
		this.mSmallHeadUrl = mHeadUrl;
	}

	public String getmOriginalHeadUrl() {
//		if(SystemUtil.mDebug){
//			SystemUtil.logd("获取原图="+mOriginalHeadUrl);
//		}

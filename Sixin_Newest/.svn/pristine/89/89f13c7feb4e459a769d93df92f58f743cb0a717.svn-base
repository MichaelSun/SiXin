...
public interface Subject {
	...
	public static interface COMMAND{
		...
		int COMMAND_UPLOAD_IMAGE_OVER = 6;//图片上传完成
		int COMMAND_MESSAGE_ERROR = 7;//消息发送失败
		int COMMAND_MESSAGE_OVER =8;//消息发送成功
		
		int COMMAND_UPLOAD_VOICE_OVER = 9;//语音上传成功
		int COMMAND_DOWNLOAD_VOICE_OVER = 10;//语音下载成功
		int COMMAND_PLAY_VOICE_OVER = 11;//语音听完
...
//	public void notifyUpdate(int command,Map<String,Object> data);

...
import com.renren.mobile.chat.holder.ChatItemHolder.InitViewHolder;
import com.renren.mobile.chat.views.ChatFeedView;
import com.renren.mobile.chat.views.VoiceLinearLayout;

public abstract class BaseInitHolder extends InitViewHolder{
	...
	public BaseInitHolder(View view) {
		super(view);
	}
	@Override

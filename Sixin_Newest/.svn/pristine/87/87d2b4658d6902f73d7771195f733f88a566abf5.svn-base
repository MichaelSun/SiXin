 ...
 * */
public interface ChatSession_Column extends DatabaseColumn{
	...
	@Column(defineType=DatabaseTypeConstant.INT)
	public final String IS_GROUP_MESSAGE = "is_group_message";//是否是群消息
	
	@Column(defineType=DatabaseTypeConstant.INT)
	public final String GROUP_ID = "group_id";//群ID

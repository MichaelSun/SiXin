...
import com.data.xmpp.childs.Message_Action;
import com.data.xmpp.childs.Message_Body;
import com.data.xmpp.childs.Message_Feed;
import com.data.xmpp.childs.Message_Time;

public class Message extends XMPPNodeRoot {
	...
	public Message_Body mBody = null;

	@XMLMapping(Type = XMLType.NODE, Name = "action")
	public Message_Action mAction = null;

	@XMLMapping(Type = XMLType.NODE, Name = "feed")
	public Message_Feed mFeedNode = null;
	
//	@XMLMapping(Type = XMLType.NODE, Name = "time")
//	public Message_Time mTimeNode = null;
	...
	// String str = "234744463@talk.xiao".split("[@]")[0];
	...
	public static void main(String... args) {
		String from = "roomId@muc.m.renren.com/senderId";
